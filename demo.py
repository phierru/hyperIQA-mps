...
model_hyper = models.HyperNet(16, 112, 224, 112, 56, 28, 14, 7).to('mps')
model_hyper.train(False)
# load our pre-trained model on the koniq-10k dataset
model_hyper.load_state_dict((torch.load('./pretrained/koniq_pretrained.pkl', map_location=torch.device('mps') )))
